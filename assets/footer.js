...
(function () {
  ...
  const WA_LABEL = "+49 172 592 5858";
  const MAIL_toggle = "luderbein_gravur@icloud.com";
  const INSTA_HANDLE = "@Luderbein_Gravur";
      ...
      <div class="small">
        ...
        <div style="display:flex; gap:10px; flex-wrap:wrap; align-items:center;">
          <a class="btn primary" href="https://wa.me/${WA_NUMBER}" rel="noopener">
            ...
            WhatsApp <span class="small" style="margin-left:6px; color:rgba(210,207,206,.82)">${WA_LABEL}</span>
          </a>
          ...
          <a class="btn" href="${INSTA_URL}" rel="me noopener">
            ...
            Instagram <span class="small" style="margin-left:6px; color:rgba(210,207,206,.82)">${INSTA_HANDLE}</span>
          </a>
