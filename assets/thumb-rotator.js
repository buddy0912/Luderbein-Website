/* =========================================================
   ...
   ---------------------------------------------------------
   - Automatischer Crossfade der Thumbnails
   - Läuft nur bei Elementen mit data-thumb-rotator
   - Gibt Statusmeldungen in der Konsole aus
   - Stromsparend mit requestAnimationFrame
   ========================================================= */
...
(function () {
  ...
  // Bewegung reduzieren -> alles stoppen
